...
🔍 SQL queries? Check them out here: [SQL_Project_1_Files](/SQL_Project_1_Files/)

# Background
Driven by a quest to navigate the data analyst job market more effectively, this project was born from a desire to pinpoint top-paid and in-demand skills, streamlining others work to find optimal jobs.

Data hails from Luke Barousse's [SQL Course](https://www.lukebarousse.com/sql). The data is from 2023, and it is packed with insights on job titles, salaries, locations, and essential skills.
...
![Top Paying Skills For Data Analysts](assets/2_top_paying_roles_skills.png)
...
| Skill ID | Skill       | Average Salary | Demand Count |
|----------|-------------|----------------|---------------|
| 8        | go          | 115320         | 27            |
